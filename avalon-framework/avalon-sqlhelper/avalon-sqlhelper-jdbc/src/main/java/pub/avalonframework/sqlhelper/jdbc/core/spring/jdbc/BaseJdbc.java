...
public abstract class BaseJdbc<T, H extends TableHelper<H, HC, HO, HW, HG, HH, HS>,
    ...
    public int insertJavaBean(T javaBean, ColumnLambdaCallable<HC> columnLambdaCallable) {
        return jdbcHelper.insertJavaBean(javaBean, new JdbcInsertEngine<>(jdbcHelper, tableHelperClass).insert(columnLambdaCallable));
    }
