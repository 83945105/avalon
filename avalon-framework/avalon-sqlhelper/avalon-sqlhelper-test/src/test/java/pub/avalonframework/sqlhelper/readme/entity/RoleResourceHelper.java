...
public class RoleResourceHelper implements TableHelper<RoleResourceHelper, RoleResourceHelper.Column, RoleResourceHelper.On, RoleResourceHelper.Where, RoleResourceHelper.Group, RoleResourceHelper.Having, RoleResourceHelper.Sort> {
