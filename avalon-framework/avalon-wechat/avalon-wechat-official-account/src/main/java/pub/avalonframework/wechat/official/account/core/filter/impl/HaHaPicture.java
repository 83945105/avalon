 ...
 * @author baichao
 */
public class HaHaPicture extends TextFilter {

    /**
     * 请求地址
     */
    public final static String url = "http://japi.juhe.cn/joke/img/text.from";
    /**
     * 聚合数据申请的key
     */
     ...
     * 最大页数
     */
    public final static int MaxPage = 100707;
...
//                        + "?page=" + DataUtil.getRandomNum(MaxPage)
//                        + "&pagesize=1&key=" + key));
...
//
//                    return BaseMessageUtil.buildNewsMessage(respBaseMessage
//                            , BaseMessageUtil.buildArticle(resultMap.get("content").toString()
//                                    , "好笑吧.233"
//                                    , resultMap.get("url").toString()
//                                    , resultMap.get("url").toString()));
//                } else {
//                    return BaseMessageUtil.buildTextMessage(respBaseMessage, "系统繁忙,请稍后尝试！");
//                }
//            }
//        } catch (Exception e) {
//        	e.printStackTrace();
