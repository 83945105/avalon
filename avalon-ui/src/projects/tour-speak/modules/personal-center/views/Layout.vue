<template>
    <div>
            ...
            <div class="common-w-main-1 common-margin-auto">
                ...
                <div class="hw-ui-layout-header-system">
                    <div class="hw-ui-layout-header-system-nav third-element-introduction">
                        <header-menu value="PersonalCenter"
                                     :data="headerMenuData"
                                     :width="400"
                                     text-color="#ffffff"
        ...
        <div class="common-full tour-layout-right common-scroll-v" style="top: 60px; background-color: #F5F5F5">
            <!--右侧内容-->
            <div class="common-w-main-1" style="margin: 15px auto;">
    ...
    export default {
        ...
        methods: {
            ...
            handleSelectedHeaderMenuItem({row, $index}) {
                if (row.value === 'PersonalCenter') return;
